    ...
    <div>
        <div class="container" style="background-color:#eceff1; float:left; margin-left:18%; margin-right:18%;">
                <div style="background-color:#ffebee; padding: 40px 40px 0px 40px; text-align: center;">
			        <span style="font-size: 30px; color:#f44336;">Appointments</span>
                </div>
                    ...
                    <br />
                        <table>
                            <tr>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ErrorMessage="*Required Field" ForeColor="Red" ControlToValidate="fname" runat="server" />
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style2">
                                    ...
                                    <asp:ListItem Text="Femele" Value="female" />
                            ...
                            <tr>
                                <td class="auto-style2">
                                <asp:TextBox ID="doa" CssClass="TextBox" TextMode="Date" placeholder="Date of Appointment..." runat="server" />  
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ErrorMessage="*Required Field" ForeColor="Red" ControlToValidate="doa" runat="server" /></td>
                            ...
                            <tr>
                                <td class="auto-style2">
                                    <textarea runat="server" id="address" cols="5" placeholder="Your Address..." class="TextBox" style="border-right:1px solid #f44336;"></textarea> <br />                            
                                </td>
                                <td class="auto-style1">
                                    <textarea runat="server" id="address2" cols="5" placeholder="Secondry Address(if any)..." class="TextBox" style="border-right:1px solid #f44336;"></textarea> <br />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ErrorMessage="*Required Field" ForeColor="Red" ControlToValidate="address" runat="server" />   
                                </td>
                            </tr>
                            <tr>
